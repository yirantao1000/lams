...
def parseConnectionArguments(parser = argparse.ArgumentParser()):
    ...
    parser.add_argument("--object", default="location", type=str, help="")
    parser.add_argument('--sample', default=True, type=bool, help="")
    parser.add_argument('--no_moving_bottle', action='store_true')
    parser.add_argument("--config_path", default='configs/cap_default.json')
    # parser.add_argument("--participant_number", default=None)
    parser.add_argument("--manual_mode_switching", default=False)
    
    parser.add_argument("--four_modes_for_manual_or_heuristic", default=False)
    parser.add_argument("--kinematics_for_mode_switching", default=False)
